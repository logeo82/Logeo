...
# Load core modules once. Chercher-Trouver is restored below; market_search is
# intentionally not imported because ct_restore already registers its page.
...
# Chercher-Trouver is provided by ct_restore. Importing market_search as well
# creates the duplicate owner_market_page endpoint and disables the feature.
